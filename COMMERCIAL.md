...
1. **Preamble**: This Agreement, signed on Dec 25, 2018 (hereinafter: Effective Date) governs the relationship between Licensee, a Business Entity, (hereinafter: Licensee) and [Instituto Superior Técnico (IST)](https://tecnico.ulisboa.pt/en/) (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using this source code (hereinafter: The Software) created and owned by Licensor, as detailed herein.
